...
import Leaflet from "views/Dashboard/Map/components/Leaflet";
...
const MapDataOverview = ({ title, percentage, activeButton }) => {
  ...
  return (
    <Card p='10px' mb={{ sm: "26px", lg: "0px" }}>
      {isLoading ? (
        <div>Loading...</div>
      ):(<Box w={{ sm: "100%", md: '100%', lg: "100%" }} h={{ sm: "220px", md: '700px', lg: "220px" }} ps='8px'>
